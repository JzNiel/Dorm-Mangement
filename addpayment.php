<?php 
  ...
  if(isset($_POST['update'])) {
    ...
    $query = "UPDATE students SET value = '$value', date = '$date'
...
<body>
  ...
  <?php include 'header.php'; ?> <br><br><br><br><br><br>
      ...
      <strong class="title">Payment & Date of Joining</strong>
    ...
    <div class="edit-form box-left clearfix">
      ...
      <input type="datetime-local" name="date" class="form-control shadow-none rounded-pull">
        ...
        <div class="form-footer btn-group">
          ...
          <input class="btn btn-primary" type="submit" name="update" value="Submit Now">
